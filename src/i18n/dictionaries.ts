...
export interface Dictionary {
  ...
  nav: { about: string; skills: string; work: string; education: string; interests: string; contact: string; hireMe: string };
  hero: {
    tag: string;
    ...
    id: { id: string; age: string; loc: string; status: string; statusValue: string; locValue: string };
    meta: { email: string; location: string; freelance: string; freelanceValue: string; years: string; yearsValue: string };
  };
  skills: { sectionMeta: string; sectionTag: string; titleL1: string; titleL2: string };
  work: { sectionMeta: string; sectionTag: string; titleL1: string; titleL2: string; titleL3: string; labels: { type: string; model: string } };
  education: { sectionMeta: string; sectionTag: string; titleL1: string; titleL2: string; reference: string };
  interests: { sectionMeta: string; sectionTag: string; titleL1: string; titleL2: string; titleL3: string };
  contact: {
    sectionMeta: string; sectionTag: string;
    titleL1: string; titleL2: string; titleL3: string;
    linkedin: string; github: string; instagram: string; resume: string;
...
const es: Dictionary = {
  ...
  hero: {
    ...
    id: { id: 'ID / 001', age: 'EDAD', loc: 'UBI', status: 'ESTADO', statusValue: 'DISPONIBLE', locValue: 'SANTANDER · ES' },
    meta: {
      email: 'EMAIL',
      location: 'UBICACIÓN',
      freelance: 'FREELANCE',
  ...
  contact: {
    ...
    titleL2: 'DE UN',
    titleL3: 'PROYECTO?',
    linkedin: 'LINKEDIN / @MCOLLADO',
    github: 'GITHUB / @MCOLLADO',
    instagram: 'INSTAGRAM / @MCOLLADOPHOTOGRAPHY',
    resume: 'DESCARGAR CV / PDF',
    terminal: { availability: 'DISPONIBLE_OPORTUNIDADES=true', location: 'Santander, Cantabria, ES' },
  },
  footer: { built: '© 2026 MARTIN COLLADO · HECHO CON', version: 'v2026.04 · ÚLTIMO DEPLOY: HOY' },
...
const en: Dictionary = {
  ...
  hero: {
    ...
    id: { id: 'ID / 001', age: 'AGE', loc: 'LOC', status: 'STATUS', statusValue: 'OPEN TO WORK', locValue: 'SANTANDER · ES' },
    meta: {
      email: 'EMAIL',
      location: 'LOCATION',
      freelance: 'FREELANCE',
  ...
  contact: {
    ...
    terminal: { availability: 'OPEN_TO_OPPORTUNITIES=true', location: 'Santander, Cantabria, ES' },
  },
  footer: { built: '© 2026 MARTIN COLLADO · BUILT WITH', version: 'v2026.04 · LAST DEPLOY: TODAY' },
